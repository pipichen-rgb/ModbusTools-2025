...
public:
    ...
    static QVariantList getSettingPort     (const Modbus::Settings &s, bool *ok = nullptr);
    ...
    static void setSettingPort     (Modbus::Settings &s, const QVariantList &v);
