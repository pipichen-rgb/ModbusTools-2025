...
mbClientRunMessageGetCommEventCounter::mbClientRunMessageGetCommEventCounter(uint8_t unit, QObject *parent) :
...
mbClientRunMessageGetCommEventLog::mbClientRunMessageGetCommEventLog(uint8_t unit, QObject *parent) :
    mbClientRunMessageRead(unit, 0, 0, 0, parent)
{
}
