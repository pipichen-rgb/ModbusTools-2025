...
public: // 'Modbus'-like Interface
    ...
    Modbus::StatusCode diagnosticsReturnBusMessageCount(mbServerPort *port, uint16_t *count);
    Modbus::StatusCode diagnosticsReturnBusCommunicationErrorCount(mbServerPort *port, uint16_t *count);
